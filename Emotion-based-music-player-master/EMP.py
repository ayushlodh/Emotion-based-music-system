...
def recognize_emotion():
    ...
    if pred == 0:
        tune = mp.newMedia("Masked Wolf - Astronaut In The Ocean (Official Music Video) (320 kbps).mp3")
        print("Angry song is playing.")
    elif pred == 1:
        tune = mp.newMedia("Alan Walker - Faded (Lyrics) (320 kbps).mp3")
        print("Happy song is playing.")
    elif pred == 2:
        tune = mp.newMedia("Alan Walker ‒ Lost Control (Lyrics) ft. Sorana (320 kbps).mp3")
        print("Sad song is playing.")
    elif pred == 3:
        tune = mp.newMedia("Alan Walker, K-391, Tungevaag, Mangoo - PLAY (Lyrics) (320 kbps).mp3")
        print("Nuetral song is playing.")
    elif pred == 4:
        tune = mp.newMedia("DJ Snake, Lauv - A Different Way (Official Video) (320 kbps).mp3")
